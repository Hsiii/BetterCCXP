...
// modified as suggested by wjchow, to enable graphic folder expansion
// add auxEv
...
//  doc.write("<img id='folderIcon" + this.id + "' name='folderIcon" + this.id + "' src='" + this.iconSrc+"' border=0></a>") 
  ...
  doc.write(auxEv + "<img id='folderIcon" + this.id + "' name='folderIcon" + this.id + "' src='" + this.iconSrc+"' border=0></a>") 
// end modification 
...
{ 
  ...
  doc.write("</a>") 
  doc.write("</td><td valign=middle nowrap class=\"tree_item\">") 
  if (USETEXTLINKS) 
...
{ 
  ...
  { 
    if (target==1) 
//zc       fullLink = "'http://"+linkData+"' target=_blank" 
       fullLink = "'"+linkData+"' target=_blank" 
    else 
//zc       fullLink = "'http://"+linkData+"' target=\""+basefrm+"\"" 
       fullLink = "'"+linkData+"' target=\""+basefrm+"\"" 
  } 
